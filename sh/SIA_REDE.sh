...
SIA_REDE(){
optD=$(dialog --stdout --title "SIA - REDE " --menu "Informcoes Sistema" 0 0 0 \
...
8 "Voltar" )
	...
	case $optD in 
		1)
		touch rede.info ; ifconfig > rede.info
		...
		;;
		4)
		touch rota.info; ip route show > roda.info
		...
		touch resolv.novo ; echo "$novo" > resolv.novo
